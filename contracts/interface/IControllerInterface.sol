...
interface IControllerAdminInterface {
    ...
    event RedeemPaused(address dlToken, bool paused);

    function _setRedeemPaused(address dlToken, bool paused) external;
    ...
    function _setAllPaused(bool _paused) external;
